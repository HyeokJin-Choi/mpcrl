...
class GreenhouseLearningAgent(LstdQLearningAgent, GreenhouseAgent):
    ...
    def update(self) -> Optional[str]:
        ...
        return None if (stats is None or (isinstance(stats, dict) and stats.get("success", False))) else (stats.get("return_status","UpdateFailed") if isinstance(stats, dict) else stats)
